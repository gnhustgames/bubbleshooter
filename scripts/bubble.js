...
$jscomp.polyfill("Promise", function(a) {
    ...
    b.race = function(a) {
        return new b(function(c, b) {
            for (var d = $jscomp.makeIterator(a), e = d.next(); !e.done; e = d.next()) g(e.value).callWhenSettled_(c,
                b)
        })
    };
    b.all = function(a) {
...
Bubble.prototype.check_nearest = function(a, d) {
    ...
    l && (this.array_bubble[l.y][l.x].filled = !0, this.array_bubble[l.y][l.x].color =
        a.color, this.add_bubble_stand(l.x, l.y, a.color));
    return l
};
        ...
        var c = !1,
            ...
            m = setInterval(function() {
                for (var b = {}, f = 0; f < l; b = {
                    ...
                    }, f++) e[f].index === h && (b.$jscomp$loop$prop$p$10$20 = e[f].obj, play_sound("pop",
                    this.scope), this.scope.tweens.add({
...
Bubble.prototype.check_unlinked = function() {
    ...
    for (b = e = 0; b < _data.max_col; b++)
        for (var f = 0; f < _data.row; f++) this.array_bubble[b][f].filled &&
            !this.array_bubble[b][f].linked && e++;
    return e
};
...
Bubble.prototype.collision_effect = function(a, d) {
    ...
    for (var b = this.scope, f = this.bubble_stand.getLength(), k = this.bubble_stand.getChildren(), c = 0; c < f; c++) {
        var h = k[c];
        g(h, a) && h.pos_x >= a.x - 1 && h.pos_x <= a.x + 1 && h.pos_y <= a.y + 1 && h.pos_y >=
            a.y - 1 ? e(h, 1.5) : g(h, a) && h.pos_x >= a.x - 2 && h.pos_x <= a.x + 2 && h.pos_y <= a.y + 2 && h.pos_y >= a.y - 3 ? e(h, 5) : g(h, a) && h.pos_x >= a.x - 1 && h.pos_x <= a.x + 1 && h.pos_y <= a.y + 3 && h.pos_y >= a.y - 5 && e(h, 12);
        g(h, a) || e(h, 1, !0)
    }
};
    ...
    return new Promise(function(d) {
        ...
        if (!e) {
            ...
            if ("random" === a)
                ...
                for (var f = 0; f <
                    _data.row; f++) 0 <= b && 1 === this.array_level[b][f][0] && this.add_bubble_stand(f, -1, this.array_level[b][f][1])
            }
