...
window.GD_OPTIONS = {
    gameId: "21cd459a9ad94c25864cada0bc85d840",
    onEvent: function(a) {}
};
(function(a, e, d) {
    var b = a.getElementsByTagName(e)[0];
    a.getElementById(d) || (a = a.createElement(e), a.id = d, a.src = "js/main.min.js", b.parentNode.insertBefore(a, b))
...
Load.prototype.preload = function() {
    ...
    this.load.image("btn_next_square",
        "img/btn_next_square.png");
...
Menu.prototype.create = function() {
    ...
    this.input.on("gameobjectdown", function(b, m) {
        ...
        this.tweens.add({
            ...
            onComplete: function() {
                if ("menu" === e)
                    if ("play" === m.name) show_ad(), d.scene.start("level");
...
Level.prototype.create = function() {
    ...
    this.input.keyboard.on("keydown", function(c) {
        "ArrowRight" ===
        c.key ? a.bind(this)("right") : "ArrowLeft" === c.key && a.bind(this)("left")
    }, this);
...
Game.prototype.create = function() {
    ...
    function t() {
        ...
        a.alpha = .5;
        q.create(config.width / 2, config.height /
            2, "win_lose");
    ...
    function n() {
        _data.cur_level === _data.unlocked_level && _data.cur_level < _data.total_level && (_data.unlocked_level++, localStorage.setItem("rf_bubble_shooter_unlocked",
            _data.unlocked_level));
    ...
    this.input.on("gameobjectdown", function(a, b) {
        b.button && ("swap" === b.name ? play_sound("swap", c) : play_sound("click", c), this.tweens.add({
            ...
            onComplete: function() {
                if ("play" === v)
                    if ("swap" === b.name) f();
                        ...
                        if ("pause" === b.name) {
                            v = "paused";
                            q = c.add.group();
                            var a = c.add.rectangle(360,
                                540, 720, 1080, 0).setInteractive();
                            a.alpha = .5;
                ...
                else "restart" === b.name || "restart_square" === b.name ? (show_ad(), c.scene.start("game")) : "home" === b.name || "home_square" === b.name ? (show_ad(), c.scene.start("menu")) : "close" === b.name ?
                    (q.destroy(!0, !0), v = "play") : "next_square" === b.name ? (show_ad(), _data.cur_level < _data.total_level ? (_data.cur_level++, c.scene.start("game")) : c.scene.start("level")) : "sound" === b.name && switch_audio(b)
            }
        }))
    }, this);
